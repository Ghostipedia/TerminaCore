package com.ghostipedia.terminacore.common.machine.multiblock.part;
...
public class TerminaParallelHatchPartMachine extends TieredPartMachine implements IFancyUIMachine, IParallelHatch {

    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(
            TerminaParallelHatchPartMachine.class, MultiblockPartMachine.MANAGED_FIELD_HOLDER);
    ...
    public TerminaParallelHatchPartMachine(IMachineBlockEntity holder, int tier) {
        super(holder, tier);
