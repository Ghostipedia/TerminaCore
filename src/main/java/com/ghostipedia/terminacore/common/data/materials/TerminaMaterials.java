package com.ghostipedia.terminacore.common.data.materials;
...
public class TerminaMaterials {
    ...
    public static void register() {
        Prisma = new Material.Builder(TerminaCore.id("prisma"))
                .liquid(new FluidBuilder().state(FluidState.LIQUID).customStill())
                .element(TerminaElements.Pi)
                .buildAndRegister();
        DilutedPrisma = new Material.Builder(TerminaCore.id("diluted_prisma"))
                .liquid()
                .color(0x4995b3).secondaryColor(0x4995b3)
                .components(Prisma, 1, Water, 4)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        Virtue = new Material.Builder(TerminaCore.id("virtue_meld"))
                .liquid(new FluidBuilder().temperature(666))
                .element(TerminaElements.ViR)
                .buildAndRegister();
        TriniumNaqide = new Material.Builder(TerminaCore.id("trinium_naqide"))
                .ingot()
                ...
                .buildAndRegister();
        PrismaticTungstensteel = new Material.Builder(TerminaCore.id("prismatic_tungstensteel"))
                .ingot()
                ...
                .buildAndRegister();
        ResonantVirtueMeld = new Material.Builder(TerminaCore.id("resonant_virtue_meld"))
                .ingot()
        ...
        NaquadicSuperalloy = new Material.Builder(TerminaCore.id("naquadric_superalloy"))
                .ingot()
        ...
        Trinavine = new Material.Builder(TerminaCore.id("trinavine"))
                .ingot()
        ...
        LivingIgniclad = new Material.Builder(TerminaCore.id("living_igniclad"))
                .ingot()
                ...
                .buildAndRegister();
        PsionicGalvorn = new Material.Builder(TerminaCore.id("psionic_galvorn"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1760))
                ...
                .buildAndRegister();
        ProgrammableMatter = new Material.Builder(TerminaCore.id("programmable_matter"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1760))
                ...
                .buildAndRegister();
        ShimmeringNeutronium = new Material.Builder(TerminaCore.id("shimmering_neutronium"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1760))
                ...
                .buildAndRegister();
        CausalFabric = new Material.Builder(TerminaCore.id("causal_fabric"))
                .ingot()
                .liquid(new FluidBuilder().temperature(1760))
        ...
        Potential = new Material.Builder(TerminaCore.id("potential"))
                .dust()
                .liquid(new FluidBuilder().temperature(1500))
                .color(0x828282).secondaryColor(0x5e0f3d).iconSet(MaterialIconSet.BRIGHT)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        FalseInfinity = new Material.Builder(TerminaCore.id("false_infinity"))
                .liquid(new FluidBuilder().temperature(3500))
                .color(0x508582).secondaryColor(0x5e0f3d).iconSet(MaterialIconSet.BRIGHT)
                .flags(DISABLE_DECOMPOSITION)
                .buildAndRegister();
        SuitableInfinity = new Material.Builder(TerminaCore.id("suitable_infinity"))
        ...
        LogicalInfinity = new Material.Builder(TerminaCore.id("logical_infinity"))
                .ingot()
                .liquid(new FluidBuilder().temperature(10750))
                .iconSet(TerminaMaterialSet.INFINITY)
        ...
        Taranium = new Material.Builder(TerminaCore.id("taranium"))
                .ingot()
                ...
                .buildAndRegister();
        //Todo Temporal Tear
        Chronon = new Material.Builder(TerminaCore.id("chronon"))
                .ingot()
                .liquid(new FluidBuilder().temperature(100000000))
                .iconSet(TerminaMaterialSet.CHRONON)
                .flags(GENERATE_BOLT_SCREW,GENERATE_ROUND,GENERATE_GEAR, GENERATE_SMALL_GEAR, GENERATE_RING, GENERATE_FRAME, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_FINE_WIRE)
                .cableProperties(GTValues.V[12], 64, 0, true)
                .buildAndRegister();
        ...
        Temmerite = new Material.Builder(TerminaCore.id("temmerite"))
                .ingot()
        ...
        Ichor = new Material.Builder(TerminaCore.id("ichor"))
                .liquid(new FluidBuilder().temperature(19500))
        ...
        Ichorium = new Material.Builder(TerminaCore.id("ichorium"))
                .ingot()
                .liquid(new FluidBuilder().temperature(19500))
                .color(0xfca103).secondaryColor(0xfcbe03).iconSet(MaterialIconSet.BRIGHT)
                .flags(GENERATE_BOLT_SCREW,GENERATE_ROUND,GENERATE_GEAR, GENERATE_SMALL_GEAR, GENERATE_RING, GENERATE_FRAME, GENERATE_SPRING, GENERATE_SPRING_SMALL, GENERATE_FINE_WIRE)
        ...
        Cosmocite = new Material.Builder(TerminaCore.id("cosmocite"))
        ...
        TearsOfTheUniverse = new Material.Builder(TerminaCore.id("universe_tears"))
        ...
        StygianPlague = new Material.Builder(TerminaCore.id("stygian_plague"))
        ...
        EnragedStygianPlague = new Material.Builder(TerminaCore.id("enraged_stygian_plague"))
        ...
        Spacetime = new Material.Builder(TerminaCore.id("spacetime"))
