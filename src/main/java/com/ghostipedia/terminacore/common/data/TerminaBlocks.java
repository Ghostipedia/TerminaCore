...
public class TerminaBlocks {
    ...
    public static final BlockEntry<Block> NAQUADAH_PRESSURE_RESISTANT_CASING = createCasingBlock(
            ...
            TerminaCore.id("block/casings/solid/naquadah_pressure_resistant_casing"));
    public static final BlockEntry<Block> RESONANTLY_TUNED_VIRTUE_MELD_CASING = createCasingBlock(
            ...
            TerminaCore.id("block/casings/solid/resonantly_tuned_virtue_meld_casing"));
    ...
    public static final BlockEntry<Block> PLATED_AEROCLOUD = createCasingBlock("plated_aerocloud",
            TerminaCore.id("block/casings/solid/plated_aerocloud"));
    ...
    public static final BlockEntry<Block> HIGH_TEMP_FISSION_CASING = createCasingBlockWrenchOnly(
            "high_temperature_fission_casing", TerminaCore.id("block/casings/solid/high_temperature_fission_casing"));
    public static final BlockEntry<Block> VOMAHINE_CERTIFIED_CHEMICALLY_RESISTANT_CASING = createCasingBlockWrenchOnly(
            "vomahine_certified_chemically_resistant_casing",
            TerminaCore.id("block/casings/solid/vomahine_certified_chemically_resistant_casing"));
    public static final BlockEntry<Block> VOMAHINE_CERTIFIED_CHEMICALLY_RESISTANT_PIPE = createCasingBlockWrenchOnly(
            "vomahine_certified_chemically_resistant_pipe",
            TerminaCore.id("block/casings/solid/vomahine_certified_chemically_resistant_pipe"));
    public static final BlockEntry<Block> VOMAHINE_CERTIFIED_INTERSTELLAR_GRADE_CASING = createCasingBlockWrenchOnly(
            "vomahine_certified_interstellar_grade_casing",
            TerminaCore.id("block/casings/solid/vomahine_certified_interstellar_grade_casing"));
    public static final BlockEntry<Block> VOMAHINE_ULTRA_POWERED_CASING = createCasingBlockWrenchOnly(
            "vomahine_ultra_powered_casing", TerminaCore.id("block/casings/solid/vomahine_ultra_powered_casing"));
    public static final BlockEntry<Block> HIGHLY_CONDUCTIVE_FISSION_CASING = createCasingBlockWrenchOnly(
            "highly_conductive_fission_casing", TerminaCore.id("block/casings/solid/highly_conductive_fission_casing"));
    ...
    private static BlockEntry<Block> createCasingBlockWrenchOnly(String name, ResourceLocation texture) {
        return createCasingBlockWrenchOnly(name, RendererBlock::new, texture, () -> Blocks.IRON_BLOCK,
                () -> RenderType::cutoutMipped);
    }
    ...
    private static BlockEntry<Block> createCasingBlockWrenchOnly(String name,
                                                                 BiFunction<BlockBehaviour.Properties, IRenderer, ? extends RendererBlock> blockSupplier,
                                                                 ResourceLocation texture,
                                                                 NonNullSupplier<? extends Block> properties,
                                                                 Supplier<Supplier<RenderType>> type) {
    ...
    private static BlockEntry<Block> createBottomTopCasingBlock(String name,
                                                                BiFunction<BlockBehaviour.Properties, IRenderer, ? extends RendererBlock> blockSupplier,
    ...
    private static BlockEntry<CoilBlock> createCoilBlock(ICoilType coilType, IRenderer renderer,
        ...
        BlockEntry<CoilBlock> coilBlock = REGISTRATE
                .block("%s_coil_block".formatted(coilType.getName()),
                        p -> (CoilBlock) new TerminaCoilBlock(p, coilType, renderer, activeRenderer))
                .initialProperties(() -> Blocks.IRON_BLOCK)
