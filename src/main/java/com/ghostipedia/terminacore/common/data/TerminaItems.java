...
import com.ghostipedia.terminacore.api.item.armor.*;
...
public class TerminaItems {
    ...
    public static final ItemEntry<ComponentItem> CRYSTALLINE_INDUCTOR = REGISTRATE
            ...
            .defaultModel()
            .register();
    // public static ItemEntry<SpaceArmorComponentItem> SPACE_NANO_CHESTPLATE =
    // REGISTRATE.item("space_nanomuscle_chestplate", (p) -> new SpaceArmorComponentItem(GTArmorMaterials.ARMOR,
    ...
    // .tag(TerminaItemTags.NANOMUSCLE_SPACE_SUITE, ModItemTags.SPACE_SUITS, ModItemTags.FREEZE_RESISTANT_ARMOR,
            ...
            .item("space_quarktech_chestplate",
                    (p) -> new SpaceArmorComponentItem(GTArmorMaterials.ARMOR, ArmorItem.Type.CHESTPLATE, 20000, p)
                            .setArmorLogic(new QuarkTechSpaceSuite(ArmorItem.Type.CHESTPLATE, 8192,
                                    ...
                                    ConfigHolder.INSTANCE.tools.voltageTierNanoSuit)))
            .tag(TerminaItemTags.QUARKTECH_SPACE_SUITE, ModItemTags.SPACE_SUITS, ModItemTags.FREEZE_RESISTANT_ARMOR,
                    ModItemTags.HEAT_RESISTANT_ARMOR)
